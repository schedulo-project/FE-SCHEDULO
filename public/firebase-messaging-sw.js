...
messaging.onBackgroundMessage((payload) => {
    ...
    // 플랫폼별 최적화된 알림 옵션
    const notificationTitle = payload.data?.content_title || payload.notification?.title || "새 알림";
    const notificationBody = payload.data?.body || payload.notification?.body || "메시지가 도착했습니다";
