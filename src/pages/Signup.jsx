...
const Signup = () => {
  ...
  const onSubmit = (data) => {
    signupApi(data.email, data.password, data.studentId, data.studentPassword);
  };
        ...
        >
          ...
          <div className="flex flex-col gap-2 mt-4">
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="serviceTerms" className="text-sm text-gray-700">
                [필수] 서비스 이용약관 동의
              </label>
            </div>
            {errors.serviceTerms && (
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="marketingTerms" className="text-sm text-gray-700">
                [선택] 광고성 정보 수신 동의
              </label>
            </div>
          </div>
