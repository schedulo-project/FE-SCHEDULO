...
const StudyPlanBtn = () => {
  ...
  return (
    <div className="relative w-[5.1875rem] h-[4.52056rem] bg-[#141522] rounded-[0.27644rem] flex flex-col items-center justify-start ">
      ...
      <div className="z-10 absolute flex items-center top-[-0.8rem] justify-center w-[1.32688rem] h-[1.32688rem] bg-[#141522] rounded-full border-[1.769px] border-white text-white text-[0.774rem] font-bold font-[Satoshi]">
        ?
      </div>
